...
CardcreationComponent.ɵfac = function CardcreationComponent_Factory(t) { return new (t || CardcreationComponent)(); };
CardcreationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CardcreationComponent, selectors: [["app-cardcreation"]], decls: 29, vars: 0, consts: [[1, "main"], [1, "matter"], [1, "card"], [1, "card1"], ["src", "../../assets\\eccomerce-removebg-preview.png"], [1, "example-card"], ["mat-card-avatar", "", 1, "example-header-image"], ["mat-card-image", "", "src", "https://material.angular.io/assets/img/examples/shiba2.jpg", "alt", "Photo of a Shiba Inu"], ["mat-button", ""], [1, "butt"], ["mat-raised-button", "", "color", "primary"]], template: function CardcreationComponent_Template(rf, ctx) { if (rf & 1) {
...
SellformComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SellformComponent, selectors: [["app-sellform"]], decls: 73, vars: 27, consts: [[1, "sellpage"], [1, "header"], ["src", "../../assets/undraw_web_shopping_dd4l.svg", "width", "200px", "height", "200px", 1, "animate__animated", "animate__flash"], [1, "matter", "animate__animated", "animate__flash"], [1, "form", "example-form"], [3, "formGroup", "ngSubmit"], ["appearance", "outline", 1, "example-full-width"], [1, "label"], ["matInput", "", "formControlName", "companyname", 1, "textbox"], ["matInput", "", "formControlName", "productname", 1, "textbox"], ["formControlName", "category", "multiple", ""], [4, "ngFor", "ngForOf"], ["matInput", "", "formControlName", "type", 1, "textbox"], ["matInput", "", "formControlName", "brand", 1, "textbox"], ["type", "number", "matInput", "", "formControlName", "noofproducts", 1, "textbox"], ["matInput", "", "formControlName", "color", 1, "textbox"], ["matInput", "", "formControlName", "realprize", 1, "textbox"], ["matInput", "", "formControlName", "discount", 1, "textbox"], ["matInput", "", "formControlName", "age", 1, "textbox"], ["matInput", "", "formControlName", "size", 1, "textbox"], ["matInput", "", "formControlName", "videolink", 1, "textbox"], ["matInput", "", "formControlName", "place", 1, "textbox"], ["type", "file", "accept", ".png,.jpg", 3, "change"], [1, "signbuttons"], ["mat-button", "", "type", "submit", 1, "mainbtn", 3, "disabled"]], template: function SellformComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function SellformComponent_Template_input_change_66_listener($event) { return ctx.upload($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
